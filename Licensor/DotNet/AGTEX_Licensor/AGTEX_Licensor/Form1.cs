...
namespace AGTEX_Licensor
{
    public partial class AGTEX_LicensorForm : Form
    {
        ...
        //            DateTime newRegistrationDate = newExpiryDate.AddDays(-40);
        //           // MessageBox.Show(newRegistrationDate.ToLongDateString());
        ...
        //                GCinstallkey.SetValue("LicensedDate", "01-Jan-2016");
